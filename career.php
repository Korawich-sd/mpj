          ...
          <div class="row mt-5">
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input name="name" type="text" class="form-control rounded-0" id="inputName" placeholder="">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <select class="form-select rounded-0" name="exp" aria-label="Default select example">
                  <option value=""></option>
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input class="form-control rounded-0" name="file_pdf" type="file" id="formFile">
              </div>
            </div>
            ...
            <div class="col-md-12 text-center">
              <button type="submit" name="send_work" class="btn btn btn-dark btn-lg rounded-0 px-lg-5">สมัครงาน</button>
            </div>
          </div>
        </form>
