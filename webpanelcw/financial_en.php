...
$data_financial = $conn->prepare("SELECT * FROM financial_en");
...
if (isset($_POST['edit-financial'])) {
    ...
    $edit_financial = $conn->prepare("UPDATE financial_en SET financial_name = :financial_name, link_pdf = :link_pdf WHERE id = :id");
    ...
    if ($edit_financial) {
        ...
        echo "<meta http-equiv='refresh' content='2;url=financial_en'>";
    } else {
        echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
...
if (isset($_POST['delete_financial'])) {
    ...
    $del_financial = $conn->prepare("DELETE FROM financial_en WHERE id = :id");
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            <a href="financial"><button type="button" class="btn btn-edit1">TH</button></a>
                            <a href="financial_add_en"><button type="button" class="btn btn-edit1">Add</button></a>
                        </div>
                    </div>
                    <div class="card-body">
