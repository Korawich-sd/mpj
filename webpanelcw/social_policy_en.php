...
if (isset($_POST['save_social_policy'])) {
    ...
    $update_social_policy = $conn->prepare("UPDATE social_policy_en SET content = :content");
    ...
    if ($update_social_policy) {
        ...
        echo "<meta http-equiv='refresh' content='1.5;url=social_policy_en'>";
    } else {
        echo "<script>
        $(document).ready(function() {
            Swal.fire({
...
//query social_policy
$stmt = $conn->prepare("SELECT * FROM social_policy_en");
$stmt->execute();
                ...
                <form method="post">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="box-lang">
                                <a href="social_policy"><button type="button" class="btn btn-edit">TH</button></a>
