...
if (isset($_POST['save_safety'])) {
    ...
    $update_safety = $conn->prepare("UPDATE safety_en SET content = :content");
    ...
    if ($update_safety) {
        ...
        echo "<meta http-equiv='refresh' content='1.5;url=safety_en'>";
    } else {
        echo "<script>
        $(document).ready(function() {
            Swal.fire({
...
//query safety
$stmt = $conn->prepare("SELECT * FROM safety_en");
$stmt->execute();
                ...
                <form method="post">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="box-lang">
                                <a href="safety"><button type="button" class="btn btn-edit">TH</button></a>
