...
if (isset($_POST['add_email'])) {
    ...
    if (empty($email)) {
        ...
        try {
            ...
            $insert_email = $conn->prepare("INSERT INTO email_3(email,company_id)
            ...
            if ($insert_email) {
                ...
                echo "<meta http-equiv='refresh' content='1.5;url=email_3'>";
            } else {
                echo "<script>
                $(document).ready(function() {
                    Swal.fire({
...
if (isset($_POST['edit_email'])) {
    ...
    $insert_email = $conn->prepare("UPDATE email_3 SET email = :email WHERE id = :id");
    $insert_email->bindParam(":email", $email);
...
if(isset($_POST['delete'])){
    ...
    $del_email = $conn->prepare("DELETE FROM email_3 WHERE id = :id");
