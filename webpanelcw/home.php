...
if (isset($_POST['save_text'])) {
    ...
    $text = $conn->prepare("UPDATE slide_text SET slide_text1 = :slide_text1, slide_text2 = :slide_text2, slide_text3 = :slide_text3");
    $text->bindParam(":slide_text1", $slide_text1);
    $text->bindParam(":slide_text2", $slide_text2);
    $text->bindParam(":slide_text3", $slide_text3);
    $text->execute();

    $text = $conn->prepare("UPDATE slide_text SET slide_text1 = :slide_text1, slide_text2 = :slide_text2");
    $text->bindParam(":slide_text1", $slide_text1);
    $text->bindParam(":slide_text2", $slide_text2);
    $text->execute();

    $text = $conn->prepare("UPDATE slide_text SET slide_text1 = :slide_text1");
    $text->bindParam(":slide_text1", $slide_text1);
    $text->execute();
                            ...
                            <div class="content-text">
                                <form method="post">
                                    <div class="btn-edit-ser">
                                        <a href="home_en"><button type="button" class="btn btn-edit1">EN</button></a>
