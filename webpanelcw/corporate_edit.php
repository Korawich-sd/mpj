...
$corporate = $conn->prepare("SELECT * FROM corporate");
$corporate->execute();
...
if (isset($_POST['edit-corporate'])) {
    ...
    $text = $conn->prepare("UPDATE corporate SET content = :content");
    ...
    if ($text) {
        ...
        echo "<meta http-equiv='refresh' content='1.5;url=corporate'>";
    } else {
        echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
