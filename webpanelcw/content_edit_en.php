...
$content = $conn->prepare("SELECT * FROM content_en");
$content->execute();
...
if (isset($_GET['content_id'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM content_en WHERE content_id = :content_id");
...
if (isset($_POST['edit-content'])) {
    ...
    $text = $conn->prepare("UPDATE content_en SET content = :content");
    ...
    if ($text) {
        ...
        echo "<meta http-equiv='refresh' content='1.5;url=content_en'>";
    } else {
        echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Content (EN)</h4>
