...
$stmt = $conn->prepare("SELECT * FROM ethics_en");
$stmt->execute();
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="box-lang">
                            <a href="ethics"><button type="button" class="btn btn-edit">TH</button></a>
                            <a href="ethics_edit_en"><button type="button" class="btn btn-edit1">Edit</button></a>
                        </div>
                    </div>
