...
$data_stock = $conn->prepare("SELECT * FROM stock_en");
$data_stock->execute();
...
if (isset($_POST['edit-stock'])) {
    ...
    $edit_stock = $conn->prepare("UPDATE stock_en SET link = :link WHERE id = :id");
    ...
    if ($edit_stock) {
        ...
        echo "<meta http-equiv='refresh' content='2;url=stock_en'>";
    } else {
        echo "<script>
                    $(document).ready(function() {
                        Swal.fire({
...
//     $del_stock = $conn->prepare("DELETE FROM stock_en WHERE id = :id");
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-end">
                            <a href="stock"><button type="button" class="btn btn-edit1">TH</button></a>
