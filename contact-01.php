          ...
          <div class="row mt-5">
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input name="subject" type="text" class="form-control rounded-0" id="inputName" placeholder="กรอกชื่อเรื่อง">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group mb-3">
            ...
            <div class="col-md-6">
              <div class="form-group mb-3">
                ...
                <input name="email" class="form-control rounded-0" id="inputEmail" placeholder="กรอกอีเมล">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group mb-3">
            ...
            <div class="col-md-12 text-center">
              ...
              <div class="col-md-12 mt-2"><?php echo $alert; ?></div>
              <button type="submit" name="submit" class="btn btn btn-dark btn-lg rounded-0 px-lg-5"><i class="icofont-send-mail"></i> ส่งข้อความ</button>
